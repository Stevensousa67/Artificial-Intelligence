''' Authors: Steven Sousa & Nicolas Pace
    ...
    Date: 11/09/2024
    version: 1.1
    Description: This is a utils file for the Population History project that contains shared functions and constants.'''

import pandas as pd

FILE_PATH = './Population-History/resources/Population History.xlsx'   # Steven's file path
